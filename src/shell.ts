...
function freeFrameHeader(): string {
  ...
  const navigation = freeFrameAuthenticated ? `<nav class="ff-primary-tabs" data-testid="tabs-layout" role="tablist"><div class="ff-primary-tab" role="tab" tabindex="0" data-shell-tab="review">⌘ ${escape(st("freeframeSequences"))}</div><div class="ff-primary-tab" role="tab" tabindex="0" data-shell-tab="media">▦ ${escape(st("freeframeBrowse"))}</div></nav>` : "";
